...
LOCAL_LDLIBS := -L$(LOCAL_PATH)/../python -lpython2.7 -lGLESv1_CM -ldl -llog -lz

LOCAL_LDFLAGS += -L$(LOCAL_PATH)/../python $(APPLICATION_ADDITIONAL_LDFLAGS)
